...
func (h helpTypeGeneral) toContent() string {
	content := lipgloss.JoinVertical(lipgloss.Left,
		...
		keyStyle.Render("n")+descStyle.Render("         - Create — opens a form (name, then prompt/branch/profile). Enter through for defaults"),
		keyStyle.Render("D")+descStyle.Render("         - Delete the selection (session, or workspace on the workspaces list)"),
		keyStyle.Render("↑/j, ↓/k")+descStyle.Render("  - Navigate between rows"),
		...
		"",
		headerStyle.Render("Workspaces (the \"namespaces\"):"),
		keyStyle.Render("n")+descStyle.Render("         - On the workspaces list: create a workspace. Inside a workspace: create a session there"),
		keyStyle.Render("D")+descStyle.Render("         - Delete the selected workspace (refused while it has sessions) or session"),
		keyStyle.Render("↵")+descStyle.Render("         - Enter a workspace to see/create its sessions"),
		keyStyle.Render("A")+descStyle.Render("         - Add a workspace from anywhere (existing dir or new — git-init's new dirs)"),
		"",
